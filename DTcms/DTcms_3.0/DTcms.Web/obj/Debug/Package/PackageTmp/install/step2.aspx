<%@ Page Language="C#" AutoEventWireup="true" Inherits="DTcms.Web.install.install_step2" Codebehind="step2.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<HEAD>
<title>安装 DTCMS V<%= DTcms.Common.Utils.GetVersion()%> </title>
    ...
    <td bgcolor="#ffffff"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="2" bgcolor="#333333"><table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                <td><font color="#ffffff">欢迎安装  DTCMS V<%= DTcms.Common.Utils.GetVersion()%> </font> </td>
              </tr>
            </table></td>
        </tr>
        <tr>
          ...
          <td width="520" valign="top"><br>
            ...
            <table id="Table2" cellspacing="1" cellpadding="1" width="90%" align="center" border="0">
              <tr>
                <td height="79"><p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 欢迎您选择安装DTCMS V<%= DTcms.Common.Utils.GetVersion()%> </p>
                 <br />  &nbsp;&nbsp;&nbsp;&nbsp;
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0" ID="Table1">
  <tr>
    <td align="center"><div align="center" style="position:relative ; padding-top:60px;font-size:14px; font-family: Arial">
        ...
        Powered by DTCMS V<%= DTcms.Common.Utils.GetVersion()%> &nbsp;<br />
